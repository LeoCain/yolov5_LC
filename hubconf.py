...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from utils_2.downloads import attempt_download
    from utils_2.general import LOGGER, check_requirements, intersect_dicts, logging
    from utils_2.torch_utils import select_device
...
if __name__ == '__main__':
    ...
    from utils_2.general import cv2, print_args
